...
var InfoTip = React.createClass({displayName: "InfoTip",
    ...
    render: function() {
        return React.createElement("div", {className: infoTip.className}, 
            React.createElement("img", {width: 10, 
                 height: 10, 
                 src: questionMark, 
                 onMouseEnter: this.handleMouseEnter, 
                 onMouseLeave: this.handleMouseLeave}), 
            React.createElement("div", {className: infoTipContainer.className, 
                 style: {display: this.state.hover ? 'block' : 'none'}}, 
                React.createElement("div", {className: infoTipTriangle.className}), 
                /* keep the classes here - used for selectors on KA */
                React.createElement("div", {className: infoTipContentContainer.className}, 
                    this.props.children
                )
            )
        );
